...
function Character.create_with_attributes(name, class_name, level, points_distribution)
    ...
    local character = {
        ...
        -- Attributs de base (limités à 100 points au total)
        attributes = {
            intelligence = points_distribution and points_distribution.intelligence or character_class.base_attributes.intelligence,
            strength = points_distribution and points_distribution.strength or character_class.base_attributes.strength,
            dexterity = points_distribution and points_distribution.dexterity or character_class.base_attributes.dexterity,
            endurance = points_distribution and points_distribution.endurance or character_class.base_attributes.endurance,
            magic = points_distribution and points_distribution.magic or character_class.base_attributes.magic
        },
        
        -- Caractéristiques dérivées
        energy = DEFAULT_ENERGY,
        energy_max = DEFAULT_ENERGY,
        health = math.floor((character_class.base_energy or 100) / 10),
        health_max = math.floor((character_class.base_energy or 100) / 10),
