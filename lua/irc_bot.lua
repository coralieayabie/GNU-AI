...
function IRCBot:process_command(sender, command)
    ...
    local result = self.rpg_agent:execute_command(command, self.rpg_context)
...
function IRCBot:handle_irc_command(sender, message)
    ...
    if message:lower() == "!help" or message:lower() == "!aide" then
        self:send("PRIVMSG " .. config.irc.default_channel .. " :" .. sender .. ": Commandes disponibles: !createplayer, !createmonster, !fight, !roll, !stats, !listclasses, !help")
        return
    end
end
